        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoteQuantity = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    isDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeekDate = table.Column<int>(type: "int", nullable: true),
                    isDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefundPercent = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "794546f7-f5be-4fff-adf1-18a271ac1976", null, "Vet", "VET" },
                    { "8dccf136-42c4-4c4b-bbfc-a1ed5fff57d1", null, "Staff", "STAFF" },
                    { "af4659a2-c9f5-47f6-a22b-7f5c5bcc9ac1", null, "Manager", "MANAGER" },
                    { "d8bffc8d-a2a2-412e-8bd3-4c2d19a5157a", null, "Customer", "CUSTOMER" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "Address", "ConcurrencyStamp", "Email", "EmailConfirmed", "ExperienceYears", "FirstName", "Gender", "ImagePublicId", "ImageURL", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName", "isBanned" },
                values: new object[,]
                {
                    { "c1", 0, "789 Customer Lane", "f09624bc-786a-4b08-bb45-975aa60e4f49", null, false, null, "Alice", false, "customer1_image_id", "https://example.com/customer1.jpg", "Johnson", false, null, null, "ALICE", null, null, false, "286d7bfa-324e-455e-801b-c0f94e9b7a38", false, "alice", false },
                    { "c2", 0, "123 Customer Ave", "c39a58ea-6464-44f2-b244-871e30f6a355", null, false, null, "Bob", true, "customer2_image_id", "https://example.com/customer2.jpg", "Williams", false, null, null, "BOOOOOB", null, null, false, "aaaac280-fd26-4b13-bb61-5bc4c72234a5", false, "boooob", false },
                    { "v1", 0, "123 Vet St.", "b4e02646-313a-412c-9e99-a6b3cbc648de", null, false, 10, "John", true, "vet1_image_id", "https://example.com/vet1.jpg", "Doe", false, null, null, "JOHNDOE", null, null, false, "7bd240ed-298c-43b2-ae81-5e9d98dae714", false, "johndoe", false },
                    { "v2", 0, "456 Vet St.", "81dfc29a-a4a1-4f83-a37d-dbc2cf109713", null, false, 8, "Jane", false, "vet2_image_id", "https://example.com/vet2.jpg", "Smith", false, null, null, "JANESMITH", null, null, false, "bdeec309-dcbd-4b48-9d88-9953fe50a30e", false, "janesmith", false },
                    { "v3", 0, "456 Vet St.", "41692c28-b3e1-4d52-be93-2040e130208f", null, false, 8, "vet3", false, "vet2_image_id", "https://example.com/vet2.jpg", "Smith", false, null, null, "VET3", null, null, false, "2abb9c35-2bda-42f0-bfb8-e4ca9b5ae6e7", false, "vet3", false },
                    { "v4", 0, "456 Vet St.", "bc320435-db2f-47e8-bef8-06d38d385ade", null, false, 8, "Vet 4", false, "vet2_image_id", "https://example.com/vet2.jpg", "Smith", false, null, null, "VETERIANARY", null, null, false, "7240f358-fdc0-44fb-9665-f4b1a48f5227", false, "veterianary", false },
                    { "v5", 0, "456 Vet St.", "ae44025d-8699-4b4d-8373-bffa456e1efd", null, false, 8, "Vet 5", false, "vet2_image_id", "https://example.com/vet2.jpg", "Smith", false, null, null, "VET1000000", null, null, false, "17c8d9c9-9d1b-4789-9c53-d1e5f0e08dff", false, "vet1000000", false }
                });
            ...
            migrationBuilder.InsertData(
                table: "Payments",
                columns: new[] { "PaymentID", "Qrcode", "Type", "isDeleted" },
                values: new object[,]
                {
                    { 1, null, "In Cash", false },
                    { 2, "qrcode2", "VNPay", false }
                });

            migrationBuilder.InsertData(
                table: "Services",
                columns: new[] { "ServiceID", "Description", "EstimatedDuration", "ImageURL", "NoteQuantity", "Price", "ServiceName", "isDeleted" },
                values: new object[,]
                {
                    { 1, "A general health check for Koi fish.", 1.5, "https://example.com/service1.jpg", null, 150.00m, "Koi Health Check", false },
                    { 2, "Comprehensive pool maintenance service.", 2.0, "https://example.com/service2.jpg", null, 250.00m, "Pool Maintenance", false }
                });

            migrationBuilder.InsertData(
                table: "Slots",
                columns: new[] { "SlotID", "EndTime", "StartTime", "WeekDate", "isDeleted" },
                values: new object[,]
                {
                    { 1, new TimeOnly(10, 0, 0), new TimeOnly(9, 0, 0), 0, false },
                    { 2, new TimeOnly(12, 0, 0), new TimeOnly(11, 0, 0), 0, false },
                    { 3, new TimeOnly(12, 0, 0), new TimeOnly(9, 0, 0), 1, false },
                    { 4, new TimeOnly(12, 0, 0), new TimeOnly(11, 0, 0), 1, false },
                    { 5, new TimeOnly(12, 0, 0), new TimeOnly(11, 0, 0), 2, false }
                });
            ...
            migrationBuilder.InsertData(
                table: "KoiOrPools",
                columns: new[] { "KoiOrPoolID", "CustomerID", "Description", "IsPool", "Name", "isDeleted" },
                values: new object[,]
                {
                    { 1, "c1", "A beautiful koi pond owned by John.", false, "John's Koi Pond", false },
                    { 2, "c2", "A large swimming pool owned by the Smith family.", true, "Smith's Pool", false }
                });
