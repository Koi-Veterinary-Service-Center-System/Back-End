    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Slot>().HasData(
            ...
            new Slot
            {
                ...
                EndTime = new TimeOnly(11, 0),  // 2 hours
            ...
            new Slot
            {
                ...
                EndTime = new TimeOnly(13, 0),  // 2 hours
                WeekDate = Models.Enum.DayOfWeek.Monday
            },
            new Slot
            {
            ...
            new Slot
            {
                ...
                EndTime = new TimeOnly(12, 0),  // 4 hours
            ...
            new Slot
            {
                ...
                EndTime = new TimeOnly(15, 0),  // 3 hours
                WeekDate = Models.Enum.DayOfWeek.Wednesday
            },
            new Slot
            {
            ...
            new Slot
            {
                ...
                EndTime = new TimeOnly(9, 0),  // 2 hours
            ...
            new Slot
            {
                ...
                EndTime = new TimeOnly(13, 0),  // 3 hours
                WeekDate = Models.Enum.DayOfWeek.Thursday
            },
            new Slot
            {
        ...
        modelBuilder.Entity<Service>().HasData(
            ...
            {
                ServiceID = 1,
                ServiceName = "On-Site Koi Health Check Service",
                Description = "A general health check for Koi fish at your location.",
                Price = 150000M,
            ...
            {
                ServiceID = 2,
                ServiceName = "In-Center Koi Health Check Service",
                Description = "A general health check for Koi fish at center.",
                Price = 150000M,
                QuantityPrice = 25000M,
                EstimatedDuration = 1.5,
                IsAtHome = false,
            ...
            {
                ServiceID = 3,
                ServiceName = "Online Koi Breeding Consultation",
            ...
            {
                ServiceID = 4,
                ServiceName = "On-Site Koi Breeding Consultation",
                Description = "Expert advice and consultation on breeding healthy Koi fish.",
                Price = 100000M,
                QuantityPrice = 0,
                EstimatedDuration = 3.0,
            ...
            {
                ServiceID = 5,
                ServiceName = "In-Center Disease Treatment Service",
                Description = "Diagnosing and treating diseases in Koi fish at center.",
                Price = 199000M,
                QuantityPrice = 25000M,
            ...
            {
                ServiceID = 6,
                ServiceName = "On-site Disease Treatment Service",
                Description = "Diagnosing and treating diseases in Koi fish at your location.",
                Price = 199000M,
                QuantityPrice = 25000M,
                EstimatedDuration = 2.5,
                IsAtHome = true,
        ...
        modelBuilder.Entity<Booking>().HasData(
            new Booking
            {
                ...
                ServicePriceAtBooking = 100000M,
                ServiceQuantityPriceAtBooking = 100000M,
                SlotID = 1,
            ...
            new Booking
            {
                ...
                ServicePriceAtBooking = 150000M,
                ServiceQuantityPriceAtBooking = 300000M,
                SlotID = 2,
